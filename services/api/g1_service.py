...
def run_g1_analysis(
    ...
    try:
        ...
        if not critic_ok:
            ...
            # Once a stronger stop reason appears, keep it instead of letting later gates overwrite it.
        ...
        if not policy_ok:
            ...
            stop_reason = resolve_stop_reason(stop_reason, "needs_human")
        run_control_prompt, run_control_input, run_control_output = _build_run_control_trace_strings(stop_reason, steps_used)
    finally:
